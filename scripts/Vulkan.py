...
VULKAN_SDK_INSTALLER_URL = 'https://sdk.lunarg.com/sdk/download/1.3.296.0/windows/vulkan_sdk.exe'
ORANGE_VULKAN_VERSION = '1.3.296.0'
VULKAN_SDK_EXE_PATH = 'Orange/vendor/VulkanSDK/VulkanSDK.exe'
...
OutputDirectory = "Orange/vendor/VulkanSDK"
